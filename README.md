...
```javascript
pareto1 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-pareto-type1@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-base-pareto-type1@umd/bundle.js"></script>
```
